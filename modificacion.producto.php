...
<script type="text/javascript" src="js/modificacion.producto.js"></script>
	  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">



		<div id="contenido" class="card-panel">
			<center><h5>Modificación de Producto</h5></center>
			...
			<div id="datos-producto">
				<fieldset >
					...
					<form id="form_mod_producto">
						<div class="row">
							<div class="col-md-5 input-field">      
				                 <label for="username">Código</label>
				                 <input name="codigo" id="codigo" type="text" placeholder="Código" class="validate" required> 
		              		</div>
						</div>
						<div class="row">
							<div class="col-md-11 input-field">      
				                 <label for="username">Descripción</label>
				                 <input name="descripcion" id="descripcion" type="text" placeholder="Descripción" class="validate" required> 
		              		</div>
						</div>
						<div class="row">
							<div class="col-md-5 input-field">      
				                 <label for="username">Presentación</label>
				                 <input name="presentacion" id="presentacion" type="text" placeholder="Presentación" class="validate" required> 
		              		</div>
		              		<div class="col-md-3 input-field">      
				                 <label for="username">Marca</label>
				                 <input name="marca" id="marca" type="text" placeholder="Marca" class="validate" required> 
		              		</div>
		              		<div class="col-md-3 input-field">      
						...
						<input name="action" type="hidden" value="modificar_producto"> 
						<input name="id_producto" type="hidden" id="id_producto"> 
			...
			<br><br>
			<div id="buttons">
				<center><a onclick="modificacionProducto();"><button  class="btn waves-effect waves-light waves-teal " type="submit">MODIFICAR PRODUCTO<i class="material-icons right">send</i></button></a>
</center>
