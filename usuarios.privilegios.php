...
<script type="text/javascript" src="js/usuarios.privilegios.js"></script>
	  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
		...
		<div id="contenido" class="card-panel">
				...
				<fieldset >
					...
					<form>
						<div class="input-field col s6">      
			                 ...
			                 <input id="ultimo-id" type="hidden" >          
		              	</div>
		              	<div class="input-field col s6">      
			...
			<br><br>
			<div id="buttons">
				<center><a onclick="registroUsuario();"><button  class="btn waves-effect waves-light waves-teal " type="submit">REGISTRAR USUARIO<i class="material-icons right">send</i></button></a>
</center>
