...
<script type="text/javascript" src="js/listado.compras.js"></script>
	  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
		...
		<div id="contenido" class="card-panel">
			<center><h5>Listado de Compras</h5></center>

			<br>
			<a onclick='redireccion("agregar.compra.producto.php")'><button class="btn waves-effect waves-teal"><i class="material-icons right">add</i>Agregar Compra</button></a>
