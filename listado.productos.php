...
<script type="text/javascript" src="js/listado.productos.js"></script>
	  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
		...
		<div id="contenido" class="card-panel">
			<center><h5>Listado de Productos</h5></center>

			<br>
			<a onclick='agregarProducto()'><button class="btn waves-effect waves-teal"><i class="material-icons right">add</i>Agregar Producto</button></a>
